...
public class ClientController {
    ...
    @GetMapping
    public List<ClientSearchResponseItem> search(
    ...
    @GetMapping("/{id}")
    public ClientDetailsResponse getById(
            @AuthenticationPrincipal CurrentUserPrincipal principal,
    ...
    @PostMapping
    public ClientDetailsResponse create(
            @AuthenticationPrincipal CurrentUserPrincipal principal,
    ...
    @PutMapping("/{id}")
    public ClientDetailsResponse update(
            @AuthenticationPrincipal CurrentUserPrincipal principal,
            @PathVariable UUID id,
    ...
    public ClientDetailsResponse createUserAccount(
            @AuthenticationPrincipal CurrentUserPrincipal principal,
            @PathVariable UUID id,
            @Valid @RequestBody CreateClientUserAccountRequest request) {
